  ...
  <div className="md:flex items-center">
        <div className=" md:w-[478px]">
          ...
          <div>
            ...
            <p className=" text-xl text-[#010D2E] tracking-tight mt-6  ">
              Celebrate the joy of accomplishment with an app designred to traact your progress,motivate your efforts,and Celebrate your sucess.
            </p>
            <div className=" flex gap-1 items-center  mt-[30px] ">
              <button className="btn btn-primary"  >Get for free</button>
              <button className=" btn btn-text  gap-1"><span>Learn more</span><ArrowIcon clssName=" h-5 w-5"/> </button>
            </div>
          </div>
        </div>
